...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = 1153734113L;
    ...
    public final HelloJPA.PracticeJPA.domain.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new HelloJPA.PracticeJPA.domain.QFoodCategory(forProperty("foodCategory")) : null;
