...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1500833829L;
    ...
    public final HelloJPA.PracticeJPA.domain.QMember member;

    public final HelloJPA.PracticeJPA.domain.QMission mission;

    public final EnumPath<HelloJPA.PracticeJPA.domain.enums.MissionStatus> status = createEnum("status", HelloJPA.PracticeJPA.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new HelloJPA.PracticeJPA.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new HelloJPA.PracticeJPA.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
