...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = -808234821L;
    ...
    public final HelloJPA.PracticeJPA.domain.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new HelloJPA.PracticeJPA.domain.QTerms(forProperty("terms")) : null;
    }
